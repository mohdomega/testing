  ...
  return (
    <div className={cn('pt-52.5 bg-[url("/images/case-study.png")] bg-cover max-lg:pt-27', className)}>
      <Stack
        component="section"
        alignItems="center"
        className="gap-32 px-30 py-25 max-lg:gap-15 max-lg:p-15 max-sm:gap-10"
      >
          ...
          <Study
            ...
            highlightedFeatures={
              <Stack direction="row" className="gap-4 max-sm:flex-col">
                <Stack alignItems="flex-start" className="gap-4 p-6 rounded-2xl bg-white/10 max-sm:flex-row">
                  <div className="p-3 rounded-full bg-white">
