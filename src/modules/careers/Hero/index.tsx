...
export default function Hero({ className }: HeroProps) {
  return (
    <Stack
      ...
      alignItems="flex-end"
      className={cn(
        'gap-16 bg-[url("/images/bg-gradient.png")] bg-cover pt-45 px-20 pb-24 max-lg:flex-col max-lg:items-center max-lg:gap-6 max-lg:p-15 max-lg:text-center',
        className
      )}
    >
      <Stack className="gap-3 max-lg:items-center">
        ...
        <Typography variant="h1" className="text-white font-medium max-w-150 max-lg:text-4xl max-sm:text-2xl">
          Build Your Career With Us
        </Typography>
      </Stack>
      <Stack className="gap-8 max-w-124 max-lg:items-center">
        <Typography className="text-white/60">
          Whether you&apos;re taking the first step or seeking your next big move, we offer opportunities to
          grow, innovate, and make a real impact every day
        </Typography>
