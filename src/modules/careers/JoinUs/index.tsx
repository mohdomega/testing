...
export default function JoinUs({ className }: ContactUsProps) {
  return (
    <Stack
      alignItems="center"
      component="section"
      className={cn('gap-13 px-20 py-17.5 bg-white max-lg:px-18 max-sm:px-6 max-sm:py-10', className)}
    >
      ...
      <Stack direction="row" className="gap-10 w-full">
        <div className="flex-1 rounded-3xl max-lg:aspect-video relative overflow-hidden">
