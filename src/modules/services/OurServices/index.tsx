...
export default function OurServices({}: OurServicesProps) {
  return (
    <Stack
      ...
      direction="row"
      alignItems="center"
      className="bg-background gap-16 px-20 py-17.5 max-lg:flex-col"
    >
      <div className="max-w-[1440px] w-full mx-auto flex flex-col gap-16">
        <div className="flex flex-row items-center gap-16 max-lg:flex-col">
          <Stack alignItems="flex-start" className="flex-1 gap-8">
            <Stack className="gap-4">
              ...
              <Typography className="text-balance">
                From implementation to optimization, we make Salesforce easier, faster, and more aligned with
                your business goals
              </Typography>
            </Stack>
          ...
          <div className="flex-1 w-full aspect-square rounded-3xl bg-neutral-300 relative overflow-hidden max-lg:max-w-md max-lg:mx-auto">
