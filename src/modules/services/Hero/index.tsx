...
export default function Hero({ className }: HeroProps) {
  return (
    ...
    >
      <div className=" max-w-[1440px] w-full mx-auto flex flex-row items-end gap-16">
        ...
        <Stack className="gap-8 max-w-124">
          <Typography className="text-white/60">
            Whether you&apos;re just getting started or scaling up, our services are built to adapt and
            deliver real results through Salesforce
          </Typography>
