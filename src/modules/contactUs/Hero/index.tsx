...
export default function Hero({ className }: HeroProps) {
  return (
    <Stack
      ...
      alignItems="center"
      className={cn('gap-16 bg-[url("/images/bg-gradient.png")] bg-cover pt-45 px-20 pb-24', className)}
    >
      ...
      <Stack className="gap-8 max-w-105">
        <Typography className="text-white/60">
          We’re here to help. Reach out with your questions, ideas, or collaboration opportunities — and we’ll
