        ...
        <Stack className="gap-6 text-white">
          ...
          <Stack className="gap-2 max-w-120">
            ...
            <Typography variant="body2" className="text-white/60 font-light">
              Let us know what you&apos;re looking for and we’ll guide you with the right solution. At IDRMS,
              we handle every request with care, ensuring a personalized and prompt response
            </Typography>
          </Stack>
        </Stack>
      </Stack>
