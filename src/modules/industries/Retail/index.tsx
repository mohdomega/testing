        ...
        <Stack alignItems="flex-start" className="flex-1 gap-8">
          <Stack className="gap-4">
            ...
            <Typography className="text-primary-dark/60 font-medium">
              We support retail brands with omnichannel solutions that optimize inventory, enhance customer journeys, and increase sales velocity. From storefront to doorstep, we power smarter commerce
            </Typography>
          </Stack>
        </Stack>
