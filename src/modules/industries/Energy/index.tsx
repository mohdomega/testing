...
import IndustryImg13 from '/public/images/IndustryImages/industry-image-13.png';
...
export default function Energy({ className }: HealthcareProps) {
  return (
    <Stack
      component="section"
        ...
        <Stack alignItems="flex-start" className="flex-1 gap-8">
          <Stack className="gap-4">
            ...
            <Typography className="text-primary-dark/60 font-medium">
             We empower energy companies with platforms for monitoring, forecasting, and infrastructure optimization. Increase uptime, reduce costs, and enable sustainable operations with real-time data control
            </Typography>
          </Stack>
        </Stack>
