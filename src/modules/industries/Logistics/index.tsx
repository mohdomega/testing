  ...
  return (
    ...
    >
      <div className="max-w-[1440px] w-full mx-auto flex flex-col gap-15">
          ...
          <Stack alignItems="flex-start" className="flex-1 gap-8">
            <Stack className="gap-4">
              ...
              <Typography className="text-primary-dark/60 font-medium text-justify">
                We provide logistics providers with smart tools for route optimization, tracking, and
                inventory flow. Gain full visibility, reduce delivery time, and improve customer satisfaction
        ...
        <Button component={Link} href="/blogs/logistics-case-study" className="w-fit self-center">
          Read More
        </Button>
      </div>
    </Stack>
