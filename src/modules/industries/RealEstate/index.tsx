...
import IndustryImg9 from '/public/images/IndustryImages/industry-image-9.png';
...
export default function RealEstate({ className }: HealthcareProps) {
  return (
    <Stack
      component="section"
      ...
      <div className="grid grid-cols-2 items-center gap-10">
        <Stack alignItems="flex-start" className="flex-1 gap-8">
          <Stack className="gap-4">
            <TitleChip>Real Estate</TitleChip>
            <Typography variant="h2" className="text-gradient">
              Smarter Solutions for Real Estate
            </Typography>
            <Typography className="text-primary-dark/60 font-medium">
              We equip real estate teams with intelligent tools for lead tracking, property listings, and virtual experiences. Streamline operations, boost engagement, and close deals faster with integrated digital systems
            </Typography>
          </Stack>
        </Stack>
        <div className="flex-1 justify-self-end max-w-125 w-full aspect-square rounded-3xl bg-neutral-300 relative overflow-hidden">
          <Image src={IndustryImg9} alt="health care image" className="w-full h-full object-cover" />
        </div>
      </div>
      {/* TODO */}
