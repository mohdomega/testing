          ...
          <Stack alignItems="flex-start" className="flex-1 gap-8">
            <Stack className="gap-4">
              ...
              <Typography className="text-primary-dark/60 font-medium">
                We equip real estate teams with intelligent tools for lead tracking, property listings, and
                virtual experiences. Streamline operations, boost engagement, and close deals faster with
