...
interface MuleSoftProps {
    className?: string;
}

export default function MuleSoft({ className }: MuleSoftProps) {
    return (
        <Stack
            id="mulesoft"
            component="section"
        ...
        >
            <div className="max-w-[1440px] w-full mx-auto flex flex-col gap-15">
                <div className="grid grid-cols-2 items-center gap-10">
                    <Stack alignItems="flex-start" className="flex-1 gap-8">
                        <Stack className="gap-4">
                            <TitleChip>MuleSoft Integration</TitleChip>
                            <Typography variant="h2" className="text-gradient">
                                How MuleSoft Reduced Manual Processing by 40% Through Intelligent Integration
                            </Typography>
                            <Typography className="text-primary-dark/60 font-medium">
                                We help enterprise Salesforce users automate data flows and eliminate manual processing.
                                Our MuleSoft-powered integrations solve complex record matching challenges and improve
                    ...
                    <div className="flex-1 justify-self-end max-w-125 w-full aspect-square rounded-3xl bg-neutral-300 relative overflow-hidden">
                        <Image src={IndustryImg6} alt="MuleSoft Integration image" className="w-full h-full object-cover" />
                    </div>
                </div>
                ...
                <Button component={Link} href="/blogs/mulesoft-case-study" className="w-fit self-center">
                    Read More
                </Button>
            </div>
        </Stack>
