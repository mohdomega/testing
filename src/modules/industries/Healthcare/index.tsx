          ...
          <Stack alignItems="flex-start" className="flex-1 gap-8">
            <Stack className="gap-4">
              ...
              <Typography className="text-primary-dark/60 font-medium text-justify">
                ...
                departments, locations, and channels. We help unify patient engagement, service requests, and
                follow-ups with a connected digital platform to improve care coordination, operational
