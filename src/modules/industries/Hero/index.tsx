...
export default function Hero({ className }: HeroProps) {
  return (
    <Stack
      component="section"
      className={cn(
        'min-h-screen bg-[url("/images/bg-gradient.png")] bg-cover pt-42 max-lg:px-15 max-lg:pb-15 max-sm:px-6 max-sm:pb-10',
        className
      )}
    >
      <Stack alignItems="center" className="gap-10 px-20">
