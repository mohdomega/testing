...
function CarouselContent({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <div ref={carouselRef} className="overflow-x-clip" data-slot="carousel-content">
      <div
...
function CarouselDots({ className }: CarouselDotsProps) {
  ...
  return (
    <Stack
      ...
      className={cn('mt-4 gap-2', className)}
    >
      {scrollSnaps.map((_, index) => {
        return (
          <Button
            ...
            className={cn('p-1 min-h-[unset] bg-muted rounded-[50%] shadow-none', {
              'bg-primary-xDark': index === selectedIndex,
            })}
